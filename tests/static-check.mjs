...
assert.match(designTools, /easyeda_get_pcb_component_pins/);
assert.match(designTools, /easyeda_modify_pcb_component/);
assert.match(designTools, /easyeda_set_pcb_pad_net/);
assert.match(designTools, /easyeda_delete_pcb_components/);
assert.match(designTools, /easyeda_recalculate_ratlines/);
