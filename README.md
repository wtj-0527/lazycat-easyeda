...
```bash
docker build --pull -t registry.cn-shanghai.aliyuncs.com/wtjking/lazycat-easyeda:0.3.2 .
node tests/static-check.mjs
npm audit --omit=dev --audit-level=high --prefix content/easyeda-mcp
lzc-cli project release -o dist/community.lazycat.app.easyeda-pro-online-v0.3.2.lpk
```
...
The v0.3.2 API exposes 76 tools, including structured schematic/PCB actions and a
